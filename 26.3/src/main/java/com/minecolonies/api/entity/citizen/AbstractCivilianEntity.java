...
public abstract class AbstractCivilianEntity extends AbstractFastMinecoloniesEntity implements Npc
{
    ...
    {
        // 26.2: Entity#startRiding(Entity, boolean) is gone; the override point is the 3-arg form
        // (/opt/mc-src/net/minecraft/world/entity/Entity.java:2418).
        if (entity instanceof SittingEntity || entity instanceof MinecoloniesMinecart || entity instanceof MinecoloniesBoat
              || entity instanceof CavalryHorseEntity)
        {
            return super.startRiding(entity, force, true);
        }
        return false;
    }
}
