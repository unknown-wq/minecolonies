...
public class GuardGear implements Predicate<ItemStack>
{
    ...
    {
        return
          (ItemStackUtils.hasEquipmentLevel(stack, itemNeeded, minArmorLevel, maxArmorLevel)
             && stack.get(DataComponents.EQUIPPABLE) != null && stack.get(DataComponents.EQUIPPABLE).slot() == getType())
