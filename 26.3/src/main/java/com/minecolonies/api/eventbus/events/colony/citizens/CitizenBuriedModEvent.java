...
{
    /**
     * The position of the headstone that was placed.
     */
    private final BlockPos gravePosition;

    /**
     * The saved citizen data, the same data a resurrection reads.
     */
    private final CompoundTag savedCitizenNbt;

    /**
     * The name of the buried citizen.
     */
    private final String citizenName;

    /**
     * The job the buried citizen held, or null if it held none.
     */
    private final String citizenJobName;

    /**
     * The undertaker who performed the burial.
     */
    private final ICitizen undertaker;

    /**
     * The colony day the burial happened on.
     */
