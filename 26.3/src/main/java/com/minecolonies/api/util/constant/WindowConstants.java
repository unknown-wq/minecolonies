...
public final class WindowConstants
{
    ...
    /**
     * This drop down list picks the level to build to. Only free mode shows it, see
     * {@link com.minecolonies.core.debug.FreeMode}.
     */
    public static final String DROPDOWN_BUILD_LEVEL_ID = "buildlevel";
     ...
     */
    // PORT-26.2: alpha must be explicit in 26.2 or the text is invisible. Verified in 26.2: Font hands the
    // colour straight to ARGB with no fix-up for a zero alpha byte (Font.java:341). Upstream wrote 100, i.e.
    // 0x00000064, whose alpha byte is zero -- readable in 1.21.1, drawn as nothing here, which left every
    // answer button in the citizen dialogue blank. Same colour, with the alpha it always meant to have.
    // This is the same rule already recorded at WindowCrafting.java:85 and in the four *ListModuleWindow
    // classes; that sweep simply missed this constant.
    ...
    /**
     * Replacement for NeoForge's {@code Size2i} (no Fabric/vanilla equivalent).
     *
