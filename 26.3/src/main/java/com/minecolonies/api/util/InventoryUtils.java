...
public class InventoryUtils
{
    ...
    /**
     * Filters a list of items, matches the stack using {@link #compareItems(ItemStack, Item)}, in an {@link IItemHandlerCapProvider}. Uses the MetaData and {@link
    ...
    /**
     * Filters a list of items, that match the given predicate, in an {@link IItemHandlerCapProvider}.
     *
     * @param provider                    The IItemHandlerCapProvider to get items from.
     * @param itemStackSelectionPredicate The predicate to match the stack to.
     * @return List of item stacks that match the given predicate.
     */
    @NotNull
    ...
    /**
     * Method to process the given predicate for all {@link Direction} of a {@link IItemHandlerCapProvider}, including the internal one (passing null as argument).
     *
    ...
    /**
     * Filters a list of items, matches the stack using {@link #compareItems(ItemStack, Item)}, with targetItem and itemDamage as parameters, in an {@link IItemHandlerCapProvider}.
     *
    ...
    /**
     * Returns the index of the first occurrence of the block in the {@link IItemHandlerCapProvider}.
     *
     * @param provider {@link IItemHandlerCapProvider} to check.
     * @param block    Block to find.
     * @return Index of the first occurrence.
     */
    ...
    /**
     * Returns the index of the first occurrence of the Item with the given ItemDamage in the {@link IItemHandlerCapProvider}.
     *
     * @param provider   {@link IItemHandlerCapProvider} to check
     * @param targetItem Item to find.
     * @return Index of the first occurrence
    ...
    /**
     * Returns a map with all itemhandlers and slots matching the predicate in the provider. the given predicate in the {@link IItemHandlerCapProvider}.
     *
    ...
    /**
     * Returns the index of the first occurrence of an ItemStack that matches the given predicate in the {@link IItemHandlerCapProvider}.
     *
     * @param provider                    Provider to check
     * @param itemStackSelectionPredicate The predicate to match.
     * @return Index of the first occurrence
    ...
    /**
     * Returns the amount of occurrences in the {@link IItemHandlerCapProvider}.
     *
     * @param provider {@link IItemHandlerCapProvider} to scan.
     * @param block    The block to count
     * @return Amount of occurrences of stacks that match the given block and ItemDamage
     */
    ...
    /**
     * Returns the sum of the durability of occurrences in the {@link IItemHandlerCapProvider}.
     *
     * @param provider                    {@link IItemHandlerCapProvider} to scan.
     * @param itemStackSelectionPredicate The predicate used to select the stacks to count.
     * @return Amount of occurrences of stacks that match the given predicate.
    ...
    /**
     * Checks if a player has a block in the {@link IItemHandlerCapProvider}.
     *
     * @param Provider {@link IItemHandlerCapProvider} to scan
     * @param block    Block to count
     * @return True when in {@link IItemHandlerCapProvider}, otherwise false
     */
    ...
    /**
     * Checks if a player has an item in the {@link IItemHandlerCapProvider}.
     *
     * @param Provider {@link IItemHandlerCapProvider} to scan
     * @param item     Item to count
     * @return True when in {@link IItemHandlerCapProvider}, otherwise false
    ...
    /**
     * Returns if the {@link IItemHandlerCapProvider} is full.
     *
     * @param provider The {@link IItemHandlerCapProvider}.
     * @return True if the {@link IItemHandlerCapProvider} is full, false when not.
     */
    ...
    /**
     * Returns the first open slot in the {@link IItemHandlerCapProvider}.
     *
     * @param provider The {@link IItemHandlerCapProvider} to check.
     * @return slot index or -1 if none found.
     */
     ...
     *
     * @param provider  {@link IItemHandlerCapProvider} to add itemstack to.
     * @param itemStack ItemStack to add.
     ...
     *
     * @param provider {@link IItemHandlerCapProvider} to count item stacks of.
     * @return Amount of item stacks in the {@link IItemHandlerCapProvider}.
     */
    ...
    /**
     * Returns an {@link IItemHandlerCapProvider} as list of item stacks.
     *
    ...
    /**
     * Method used to check if a {@link IItemHandlerCapProvider} has any {@link IItemHandler}
     *
     ...
     * Returns an {@link IItemHandler} as list of item stacks.
     *
     * @param provider The {@link IItemHandlerCapProvider} that holds the {@link IItemHandler} for the given {@link Direction}
    ...
    /**
     * Returns the index of the first occurrence of the block in the {@link IItemHandlerCapProvider} for a given {@link Direction}.
     *
     * @param provider   {@link IItemHandlerCapProvider} to check.
    ...
    /**
     * Returns the index of the first occurrence of the Item with the given ItemDamage in the {@link IItemHandlerCapProvider} for a given {@link Direction}.
     *
     * @param provider   {@link IItemHandlerCapProvider} to check
     * @param facing     The facing to check for.
     * @param targetItem Item to find.
    ...
    /**
     * Returns the index of the first occurrence of an ItemStack that matches the given predicate in the {@link IItemHandlerCapProvider} for a given {@link Direction}.
     *
     * @param provider                    Provider to check
     * @param facing                      The facing to check for.
     * @param itemStackSelectionPredicate The predicate to match.
    ...
    /**
     * Returns the amount of occurrences in the {@link IItemHandlerCapProvider} for a given {@link Direction}.
     *
     * @param provider {@link IItemHandlerCapProvider} to scan.
    ...
    /**
     * Checks if a player has a block in the {@link IItemHandlerCapProvider}, for a given {@link Direction}.;
     * 0;
     *
     * @param provider {@link IItemHandlerCapProvider} to scan
    ...
    /**
     * Checks if a player has an item in the {@link IItemHandlerCapProvider}, for a given {@link Direction}.
     * 0;
     *
     * @param provider {@link IItemHandlerCapProvider} to scan
     * @param facing   The side to check for.
    ...
    /**
     * Returns if the {@link IItemHandlerCapProvider} is full, for a given {@link Direction}.
     *
     * @param provider The {@link IItemHandlerCapProvider}.
     * @param facing   The side to check for.
     * @return True if the {@link IItemHandlerCapProvider} is full, false when not.
    ...
    /**
     * Returns the first open slot in the {@link IItemHandlerCapProvider}, for a given {@link Direction}.
     *
     * @param provider The {@link IItemHandlerCapProvider} to check.
     * @param facing   The side to check for.
     * @return slot index or -1 if none found.
    ...
    /**
     * Method to swap the ItemStacks from the given source {@link IItemHandler} to the given target {@link IItemHandlerCapProvider}.
     *
     ...
     * @param targetProvider The {@link IItemHandlerCapProvider} that works as Target.
    ...
    /**
     * Method to swap the ItemStacks from the given source {@link IItemHandlerCapProvider} to the given target {@link IItemHandler}.
     *
     * @param sourceProvider The {@link IItemHandlerCapProvider} that works as Source.
     * @param sourceIndex    The index of the slot that is being extracted from.
     * @param targetHandler  The {@link IItemHandler} that works as Target.
     * @return True when the swap was successful, false when not.
     */
    ...
    private static void updateHeldItemFromServer(final Player player)
    {
        ...
        {
            // 26.2: ServerPlayer#server is private and PlayerList#sendAllPlayerInfo is gone; the permission-level
            // resend is the remaining public equivalent.
            ((ServerPlayer) player).level().getServer().getPlayerList().sendPlayerPermissionLevel((ServerPlayer) player);
        }
    }
