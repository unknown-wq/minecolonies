...
public final class TranslationConstants
{
    ...
    @NonNls
    public static final String COM_MINECOLONIES_COREMOD_JOB_DELIVERYMAN_WAREHOUSEFULL               = "com.minecolonies.coremod.job.deliveryman.warehousefull";
    @NonNls
    ...
    public static final String HERDER_MENU_ADDED_MESSAGE                                            = "com.minecolonies.coremod.herder.menuadded";
    @NonNls
    ...
    @NonNls
    public static final String RAID_AIR_INBOUND                     = "com.minecolonies.core.raid.air.inbound";
    @NonNls
    public static final String RAID_AIR_LANDED                      = "com.minecolonies.core.raid.air.landed";
    @NonNls
    public static final String RAID_AIR_STOPPED                     = "com.minecolonies.core.raid.air.stopped";
    @NonNls
    public static final String RAID_AIR_PARTIAL                     = "com.minecolonies.core.raid.air.partial";
    @NonNls
    public static final String AIRCRAFT_WARNING                     = "com.minecolonies.core.aircraft.warning";
    @NonNls
    public static final String AIRCRAFT_WARNING_STRIKE              = "com.minecolonies.core.aircraft.warning.strike";
    @NonNls
    public static final String AIRCRAFT_DOWNED                      = "com.minecolonies.core.aircraft.downed";
    @NonNls
    public static final String AIRCRAFT_NO_AMMO                     = "com.minecolonies.core.aircraft.noammo";
    @NonNls
    public static final String AIRCRAFT_NO_AMMO_LOCATION            = "com.minecolonies.core.aircraft.noammo.location";
    @NonNls
    public static final String AIRCRAFT_NO_AMMO_MORE_ONE            = "com.minecolonies.core.aircraft.noammo.more.one";
    @NonNls
    public static final String AIRCRAFT_NO_AMMO_MORE_MANY           = "com.minecolonies.core.aircraft.noammo.more.many";
    @NonNls
    ...
    @NonNls
    public static final String OUT_OF_COLONY_CHUNK                                                  = "com.minecolonies.coremod.workorder.outofcolony.chunk";
    @NonNls
    public static final String OUT_OF_COLONY_OTHER                                                  = "com.minecolonies.coremod.workorder.outofcolony.other";
    @NonNls
    ...
    /**
     * Same shape as {@link #WORK_ORDER_CREATED}, but for the orders that are not a build. Upstream sends the build
     * wording for every work order type, so asking for a deconstruction answered "Build request created" - see
     * {@code AbstractBuilding#requestWorkOrder}.
     */
    @NonNls
    public static final String WORK_ORDER_REMOVAL_CREATED                         = "com.minecolonies.coremod.workorderadded.removal";
    @NonNls
    public static final String WORK_ORDER_REPAIR_CREATED                          = "com.minecolonies.coremod.workorderadded.repair";
    @NonNls
    public static final String BUILDER_CANNOT_DECONSTRUCT                         = "entity.builder.cantdeconstruct";
    /**
     * A building with no blueprint path recorded. {@code WorkOrderBuilding#create} cannot make an order for one
     * without throwing, so the request is refused with this instead of dying with a stack trace.
     */
    @NonNls
    public static final String BUILDER_NO_BLUEPRINT                               = "entity.builder.noblueprint";
    @NonNls
    ...
    @NonNls
    public static final String FIELD_TOO_LARGE                                    = "com.minecolonies.coremod.gui.field.toolarge";
    @NonNls
    public static final String FIELD_GROUND_PREPARED                              = "com.minecolonies.coremod.entity.farmer.groundprepared";
    @NonNls
    public static final String FIELD_NO_SEED                                      = "com.minecolonies.coremod.entity.farmer.fieldnoseed";
    @NonNls
    public static final String FIELD_BAD_SEED                                     = "com.minecolonies.coremod.entity.farmer.fieldbadseed";
    @NonNls
    ...
    @NonNls
    public static final String MESSAGE_NEW_CHILD_BORN_HOMELESS                    = "com.minecolonies.coremod.progress.newchildhomeless";
    @NonNls
    ...
    @NonNls
    public static final String LABEL_HOUSE_ASSIGNED_CITIZENS_WITH_CHILDREN = "com.minecolonies.coremod.gui.home.assignedwithchildren";
