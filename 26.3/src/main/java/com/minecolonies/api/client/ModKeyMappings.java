 ...
 *
 * <p>26.3: {@code InputConstants.Type.KEYSYM} became {@code Type.KEYBOARD} when the input layer moved from GLFW
 * to SDL. The binding is unbound by default, so no key constant is involved.</p>
 *
