...
public interface IColonyView extends IColony
{
    ...
    /**
     * Whether free mode is on for this colony, as the server last told the client.
     * <p>
     * Only the client side needs this: free mode itself is read server side through
     * {@code FreeMode#isOn}, which is why the flag lives on {@code Colony} and not on {@link com.minecolonies.api.colony.IColony}.
     * The scarecrow window is the one place that has to agree with the server about how large a farm field may be.
     *
