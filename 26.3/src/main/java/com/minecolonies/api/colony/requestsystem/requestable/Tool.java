...
public class Tool implements IDeliverable
{
    ...
    public static CompoundTag serialize(@NotNull final HolderLookup.Provider provider, final IFactoryController controller, final Tool equipment)
    {
        ...
        compound.put(NBT_RESULT, Utils.serializeCodecMess(ItemStack.OPTIONAL_CODEC, provider, equipment.getResult()));
    ...
    public static Tool deserialize(@NotNull final HolderLookup.Provider provider, final IFactoryController controller, final CompoundTag nbt)
    {
        ...
        final ItemStack result = Utils.deserializeCodecMess(ItemStack.OPTIONAL_CODEC, provider, nbt.getCompoundOrEmpty(NBT_RESULT));
    ...
    public boolean matches(@NotNull final ItemStack stack)
    {
        ...
        {
            Log.getLogger().warn("Got exception for Itemstack when trying to match equipment level: " + stack.getDisplayName() + " - " + net.minecraft.core.registries.BuiltInRegistries.ITEM.getKey(stack.getItem()).getNamespace(), e);
            return false;
        }
    }
