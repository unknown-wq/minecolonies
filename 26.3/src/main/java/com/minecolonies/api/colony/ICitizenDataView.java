...
public interface ICitizenDataView extends ICitizen
{
    ...
    /**
     * The ids of the parents, zero where this colony cannot name one.
     * <p>
     * See {@link com.minecolonies.api.colony.ICitizenData#getParentIds()}: parents used to be stored as names alone,
     * so the family window could show a name but nothing could point at the citizen behind it.
     *
     * @return the two ids.
     */
