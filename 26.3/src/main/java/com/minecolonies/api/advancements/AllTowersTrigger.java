...
public class AllTowersTrigger extends SimpleCriterionTrigger<AllTowersTrigger.AllTowersTriggerInstance>
{
    ...
    public static record AllTowersTriggerInstance(Optional<Holder<LootItemCondition>> player) implements SimpleInstance
    {
        public static final Codec<AllTowersTriggerInstance> CODEC = RecordCodecBuilder.create(builder -> builder
            .group(LootItemCondition.CODEC.optionalFieldOf("player").forGetter(AllTowersTriggerInstance::player))
