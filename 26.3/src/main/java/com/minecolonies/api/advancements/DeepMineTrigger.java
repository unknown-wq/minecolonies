...
public class DeepMineTrigger extends SimpleCriterionTrigger<DeepMineTrigger.DeepMineTriggerInstance>
{
    ...
    public static record DeepMineTriggerInstance(Optional<Holder<LootItemCondition>> player) implements SimpleInstance
    {
        public static final Codec<DeepMineTriggerInstance> CODEC = RecordCodecBuilder.create(builder -> builder
            .group(LootItemCondition.CODEC.optionalFieldOf("player").forGetter(DeepMineTriggerInstance::player))
