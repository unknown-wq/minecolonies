...
public class CitizenBuryTrigger extends SimpleCriterionTrigger<CitizenBuryTrigger.CitizenBuryTriggerInstance>
{
    ...
    public static record CitizenBuryTriggerInstance(Optional<Holder<LootItemCondition>> player) implements SimpleInstance
    {
        public static final Codec<CitizenBuryTriggerInstance> CODEC = RecordCodecBuilder.create(builder -> builder
            .group(LootItemCondition.CODEC.optionalFieldOf("player").forGetter(CitizenBuryTriggerInstance::player))
