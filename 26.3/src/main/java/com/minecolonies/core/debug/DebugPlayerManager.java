...
public class DebugPlayerManager
{
    ...
    {
        // 26.2/Fabric: FMLEnvironment.production -> the inverse of FabricLoader's dev-environment flag.
        return FabricLoader.getInstance().isDevelopmentEnvironment() || debugPlayers.contains(player.getUUID());
    }
