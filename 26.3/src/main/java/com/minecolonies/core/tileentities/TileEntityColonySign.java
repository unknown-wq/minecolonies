...
public class TileEntityColonySign extends BlockEntity implements ITickable
{
    ...
    public void loadAdditional(@NotNull final ValueInput compound)
    {
        ...
        {
            this.anchor = ValueIoUtils.readPos(compound, TAG_POS);
        }
        ...
        {
            this.previousPosition = ValueIoUtils.readPos(compound, TAG_PREV_POS);
        }
        if (compound.contains(TAG_NEXT_POS))
        {
            this.nextPosition = ValueIoUtils.readPos(compound, TAG_NEXT_POS);
        }
    }
    ...
    public void saveAdditional(@NotNull final ValueOutput compound)
    {
        ...
        if (anchor != null)
        {
            ValueIoUtils.writePos(compound, TAG_POS, anchor);
        }
        ...
        ValueIoUtils.writePos(compound, TAG_NEXT_POS, nextPosition);
        ValueIoUtils.writePos(compound, TAG_PREV_POS, previousPosition);
    }
