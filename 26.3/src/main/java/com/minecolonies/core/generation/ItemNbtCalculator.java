...
public class ItemNbtCalculator implements DataProvider
{
    ...
    public CompletableFuture<?> run(@NotNull final CachedOutput cache)
    {
            ...
            .thenCompose(provider ->
        {
            ...
            // 26.3: DataComponents.SWING_ANIMATION was split into ATTACK_ANIMATION and INTERACT_ANIMATION
            // (/opt/mc-src-26.3/net/minecraft/core/component/DataComponents.java:222-227). Both are presentation,
            // so both are stripped, exactly as the single component was.
