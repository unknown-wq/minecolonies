...
public class DefaultResearchProvider extends AbstractResearchProvider
{
    ...
    public Collection<ResearchEffect> getResearchEffectCollection()
    {
        ...
        effects.add(new ResearchEffect(BOATS).setTranslatedName("Citizens use Boats to cross Water"));
    ...
    public Collection<Research> getCivilResearch(Collection<Research> r)
    {
        ...
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/rails"), CIVIL).setParentResearch(keen)
          ...
          .addEffect(RAILS, 1)
          .addToList(r);
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/boats"), CIVIL).setParentResearch(keen)
          .setTranslatedName("Boats")
          .setTranslatedSubtitle("Why walk around the lake?")
          .setSortOrder(6)
          .setIcon(Items.OAK_BOAT)
          .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.FISHERMAN_ID), 3)
          .addItemCost(Items.OAK_BOAT, 16, provider)
          .addEffect(BOATS, 1)
          .addToList(r);
        ...
        final Research masks = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "civilian/masks"), CIVIL).setParentResearch(firstAid2)
          ...
          .setIcon(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "textures/icons/research/hp4.png"))
          .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.LIBRARY_ID), 3)
          .addItemCost(Items.WOOL.pick(DyeColor.WHITE), 32, provider)
          .addEffect(MASKS, 1)
          .addToList(r);
    ...
    public Collection<Research> getCombatResearch(Collection<Research> r)
    {
        ...
        final Research captainTraining = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/captaintraining"), COMBAT).setParentResearch(knightTraining)
                                           ...
                                           .addToList(r);
        final Research mountedCombat = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/mountedcombat"), COMBAT).setParentResearch(tacticTraining)
        ...
        final Research coffee = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/coffee"), COMBAT).setParentResearch(tacticTraining)
                                  ...
                                  .setIcon(Items.BED.pick(DyeColor.LIME))
        ...
        final Research ivermectin = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/ivermectin"), COMBAT).setParentResearch(mountedCombat)
          ...
          .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.STABLE_ID), 2)
          .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.HOSPITAL_ID), 2)
          .addItemCost(Items.RED_MUSHROOM, 8, provider)
          .addItemCost(Items.WARPED_FUNGUS, 8, provider)
          .addEffect(MOUNT_HEALTH, 1)
          .addToList(r);

        final Research healthyDiet = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/healthdiet"), COMBAT).setParentResearch(ivermectin)
          .setTranslatedName("Healthy Diet")
          .setTranslatedSubtitle("Sugar cubes are beneath them.")
          .setIcon(Items.HAY_BLOCK)
          .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.STABLE_ID), 3)
          .addItemCost(Items.HAY_BLOCK, 2, provider)
          .addItemCost(Items.APPLE, 8, provider)
          .addEffect(MOUNT_HEALTH, 2)
          .addToList(r);

        final Research exerciseRegimen = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/exerciseregimen"), COMBAT).setParentResearch(healthyDiet)
          .setTranslatedName("Exercise Regimen")
          .setTranslatedSubtitle("War horse, warhead...")
          .setIcon(Items.GOLDEN_APPLE)
          .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.STABLE_ID), 4)
          .addItemCost(Items.GOLDEN_APPLE, 4, provider)
          .addItemCost(Items.GOLDEN_CARROT, 4, provider)
          .addEffect(MOUNT_HEALTH, 3)
          .addToList(r);

        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/bucephalus"), COMBAT).setParentResearch(exerciseRegimen)
          .setTranslatedName("Bucephalus")
          .setTranslatedSubtitle("They will go down in history.")
          .setIcon(Items.NETHER_STAR)
          .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.STABLE_ID), 5)
          .addItemCost(Items.NETHER_STAR, 1, provider)
          .addItemCost(Items.BANNER.pick(DyeColor.BLACK), 1, provider)
          .addEffect(MOUNT_HEALTH, 4)
          .addToList(r);

        final Research barding = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/barding"), COMBAT).setParentResearch(mountedCombat)
        ...
        final Research improvedBarding = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/improvedbarding"), COMBAT).setParentResearch(barding)
        ...
        final Research advancedBarding = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/advancedbarding"), COMBAT).setParentResearch(improvedBarding)
        ...
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "combat/masterbarding"), COMBAT).setParentResearch(advancedBarding)
    ...
    public Collection<Research> getTechnologyResearch(Collection<Research> r)
    {
        ...
        final Research cropRotation = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/croprotation"), TECH).setParentResearch(letItGrow)
                                        ...
                                        .setIcon(Items.DYE.pick(DyeColor.GREEN))
        ...
        .setSortOrder(2)
        .setIcon(Items.LEATHER_BOOTS)
        .addItemCost(Items.WOOL.pick(DyeColor.WHITE), 16, provider)
        ...
        final Research deepPockets = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/deeppockets"), TECH).setParentResearch(cheatSheet)
                                       ...
                                       .setSortOrder(2)
                                       .setIcon(Items.DYED_SHULKER_BOX.pick(DyeColor.PINK))
                                       .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.LIBRARY_ID), 4)
                                       .addItemCost(Items.EMERALD, 64, provider)
        ...
        final Research loaded = new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/loaded"), TECH).setParentResearch(deepPockets)
                                  ...
                                  .setIcon(Items.DYED_SHULKER_BOX.pick(DyeColor.RED))
                                  .addBuildingRequirement(Identifier.fromNamespaceAndPath(Constants.MOD_ID, ModBuildings.LIBRARY_ID), 5)
        ...
        new Research(Identifier.fromNamespaceAndPath(Constants.MOD_ID, "technology/heavilyloaded"), TECH).setParentResearch(loaded)
          ...
          .setIcon(Items.DYED_SHULKER_BOX.pick(DyeColor.BLUE))
          .setNoReset()
