...
public class ColonyIdArgument extends MultipleOptionsArgument<Integer>
{
    ...
    public static class MineOption implements ArgumentOption<Integer>
    {
        ...
        public Integer resolveValue(final CommandSourceStack source, final String value) throws CommandSyntaxException
        {
            return resolveByOwner(source, source.getPlayerOrException().getGameProfile().id());
        }
    ...
    public static class PlayerNameOption implements ArgumentOption<Integer>
    {
        ...
        public Integer resolveValue(final CommandSourceStack source, final String value) throws CommandSyntaxException
        {
            // 26.2: MinecraftServer#getProfileCache() became services().nameToIdCache(), and the cache now
            // stores NameAndId (a UUID + name record) instead of authlib GameProfile.
            final Optional<net.minecraft.server.players.NameAndId> profile =
              source.getServer().services().nameToIdCache().get(value);
