...
public class BuildingNetherWorker extends AbstractBuilding
{
    ...
    {
        super.onWakeUp();
        // 26.2: getOverworldClockTime, not getDefaultClockTime - the latter is 0 in the nether
        // (Level.java:891-897 plus DimensionTypes.java:99). Same reasoning as WorldUtil#isDayTime.
