...
public class RecipeStorageFactory implements IRecipeStorageFactory
{
    ...
    public CompoundTag serialize(@NotNull final HolderLookup.Provider provider, @NotNull final IFactoryController controller, @NotNull final RecipeStorage recipeStorage)
    {
        ...
        compound.put(NbtTagConstants.STACK, ItemStack.OPTIONAL_CODEC.encodeStart(provider.createSerializationContext(NbtOps.INSTANCE), recipeStorage.getPrimaryOutput()).getOrThrow());
        ...
        {
            altOutputTagList.add(ItemStack.OPTIONAL_CODEC.encodeStart(provider.createSerializationContext(NbtOps.INSTANCE), stack).getOrThrow());
        }
        ...
        {
            secOutputTagList.add(ItemStack.OPTIONAL_CODEC.encodeStart(provider.createSerializationContext(NbtOps.INSTANCE), stack).getOrThrow());
        }
    ...
    public RecipeStorage deserialize(@NotNull final HolderLookup.Provider provider, @NotNull final IFactoryController controller, @NotNull final CompoundTag nbt)
    {
        ...
        final EquipmentTypeEntry requiredTool = ModEquipmentTypes.getRegistry().getValue(EquipmentTypeEntry.parseResourceLocation(nbt.getStringOr(TOOL_TAG, "")));
    ...
    public RecipeStorage deserialize(@NotNull final IFactoryController controller, final RegistryFriendlyByteBuf buffer) throws Throwable
    {
        ...
        final Identifier resLoc = EquipmentTypeEntry.parseResourceLocation(buffer.readIdentifier());
