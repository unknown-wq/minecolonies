...
public class GsonHelper extends net.minecraft.util.GsonHelper
{
    ...
    public static Identifier getAsResourceLocation(final JsonObject object, final String key)
    {
        return Identifier.parse(getAsString(object, key));
    }

    public static Identifier getAsResourceLocation(final JsonObject object, final String key, final Identifier defaultValue)
    {
