...
public class WindowTownHallColonyManage extends AbstractWindowSkeleton
{
    ...
    public void onCreate()
    {
        ...
        // 26.2: DRAGON_BREATH is a ParticleType<PowerParticleOption> rather than a SimpleParticleType, so it
        // carries a power. 1.0F is what vanilla's own optional codec defaults to, i.e. the 1.21.1 appearance.
