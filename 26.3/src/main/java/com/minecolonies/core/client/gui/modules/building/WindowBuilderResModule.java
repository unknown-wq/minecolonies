...
public class WindowBuilderResModule extends AbstractModuleWindow<BuildingResourcesModuleView>
{
    ...
    public void onUpdate()
    {
        ...
        // No explicit refreshElementPanes() here: super.onUpdate() is View#onUpdate, which already forwards
        // onUpdate to every drawn child, and ScrollingList#onUpdate is itself refreshElementPanes(false)
        // (checked in blockui-0.0.1.jar). This list is a direct always-visible child of the window
        // (assets/minecolonies/gui/layouthuts/layoutbuilderres.xml), so it was being rebuilt twice per tick.
    }
