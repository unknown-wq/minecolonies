...
public abstract class AbstractBuildingMainWindow<B extends IBuildingView> extends AbstractBuildingWindow<B>
{
    ...
    public AbstractBuildingMainWindow(final B buildingView, final Identifier resource)
    {
        ...
        if (buttonInfo != null)
        {
            buttonInfo.setVisible(net.minecraft.locale.Language.getInstance().has(PARTIAL_INFO_TEXT + buildingView.getBuildingType().getTranslationKey().replace("com.minecolonies.building.", "") + ".0"));
        }
    }
