...
public class MaleStudentModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public void setupAnim(@NotNull final CitizenRenderState state)
    {
        ...
        final boolean studying = state.renderMetadata.contains(RENDER_META_STUDYING);

        rightArm.getChild("book").visible = state.renderMetadata.contains(RENDER_META_BOOK);
