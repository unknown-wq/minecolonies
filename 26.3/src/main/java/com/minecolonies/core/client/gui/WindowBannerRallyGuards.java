    ...
    public void onOpened()
    {
        ...
        guardTowerList.setDataProvider(() -> getGuardTowerViews(banner, mc.level).size(), (index, rowPane) ->
        {
            ...
            else
            {
                ...
                // PORT-26.2: alpha must be explicit in 26.2 or the text is invisible. Upstream passed alpha 1,
                // which was legible in 1.21.1; 26.2 honours it literally and draws this "tower missing" warning
                // at 1/255 opacity, i.e. not at all. Same rule as WindowConstants.SLIGHTLY_BLUE.
                rowPane.findPaneOfTypeByID(LABEL_GUARDTYPE, Text.class).setColors(Color.rgbaToInt(255, 0, 0, 255));
                rowPane.findPaneOfTypeByID(LABEL_POSITION, Text.class).setText(Component.literal(guardTower.getFirst().toString()));
            }
        });
    }
