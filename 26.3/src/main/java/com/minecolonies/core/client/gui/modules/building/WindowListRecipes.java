...
public class WindowListRecipes extends AbstractModuleWindow<CraftingModuleView>
{
    ...
    {
        // 26.3: GLFW is gone (LWJGL ships SDL now); InputConstants.KEY_* are SDL scancodes and isKeyDown
    ...
    public void onUpdate()
    {
        ...
        // No explicit refreshElementPanes() here - see WindowBuilderResModule#onUpdate: super.onUpdate()
        // already drives ScrollingList#onUpdate, which is refreshElementPanes(false). The list is a direct
        // always-visible child of the window (assets/minecolonies/gui/layouthuts/layoutlistrecipes.xml).
    }
}
