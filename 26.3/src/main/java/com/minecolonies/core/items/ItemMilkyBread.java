...
public class ItemMilkyBread extends ItemFood
{
    ...
    */
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level worldIn, LivingEntity entityLiving) {
        ...
        {
            // 26.2/Fabric: NeoForge's EffectCures registry ("which effects does milk cure") has no counterpart.
            // Vanilla milk clears every effect (MilkBucketItem -> LivingEntity#removeAllEffects), so that is what
            // milky bread does now; effects a mod marked as not-curable-by-milk are also removed.
