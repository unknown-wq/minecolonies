 ...
 */
// 26.2: net.minecraft.util.random.Weight and WeightedEntry are gone. Weight is a plain int now and it is
// carried *outside* the value, by net.minecraft.util.random.Weighted<T>, so Disease is no longer weighted
// itself -- DiseasesListener wraps each one in a Weighted<Disease> when it builds the WeightedList.
