...
public class CustomVisitorListener extends SimpleJsonResourceReloadListener<JsonElement>
{
    ...
    {
        super(DataListenerUtils.JSON_CODEC, DataListenerUtils.dir("visitors"));
    }
    ...
    private void tryParse(final Map.Entry<Identifier, JsonElement> entry)
    {
        try
        {
            ...
            {
                dataEntry.recruitCost = ItemStackUtils.idToItemStack(data.get(VISITOR_RECRUITCOST).getAsString(), DataListenerUtils.registryLookup());
            }
