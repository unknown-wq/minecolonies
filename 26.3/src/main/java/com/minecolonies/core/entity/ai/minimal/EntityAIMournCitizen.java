...
public class EntityAIMournCitizen implements IStateAI
{
    ...
    private IState stare()
    {
        ...
        {
            // 26.2 moved getNearestEntity onto ServerEntityGetter (ServerLevel only).
            closestEntity = this.citizen.level() instanceof final ServerLevel serverLevel
                              ? serverLevel.getNearestEntity(EntityCitizen.class,
