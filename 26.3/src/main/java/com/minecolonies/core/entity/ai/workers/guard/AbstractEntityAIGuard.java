...
public abstract class AbstractEntityAIGuard<J extends AbstractJobGuard<J>, B extends AbstractBuildingGuards> extends AbstractEntityAIFight<J, B>
{
    ...
    private IAIState wakeUpGuard()
    {
        ...
        {
            worker.swingForAttack(InteractionHand.OFF_HAND);
    ...
    {
        // getToolsNeeded(), not the raw toolsNeeded list: a knight fielding a spear instead of a sword owns no sword,
        // and reading the fixed list would answer "unarmed" forever, bouncing him between PREPARING and combat.
        for (final EquipmentTypeEntry toolType : getToolsNeeded())
        {
