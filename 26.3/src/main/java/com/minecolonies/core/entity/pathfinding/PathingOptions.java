...
public class PathingOptions
{
    ...
    /**
     * Cost improvement of travelling a water surface node by boat - base 1.
     * <p>
     * Deliberately less of a discount than {@link #onRailCost}: rails are built by the player and are meant to be
     * strongly preferred, open water is everywhere and should not start acting like a highway.
     */
    public double onBoatCost = 1 / 8D;

    /**
     * Cost of boarding a boat, i.e. of the first water node of a crossing.
     * <p>
     * The boat counterpart of {@link #swimCostEnter}, and much cheaper than it -- that is the whole point, a citizen
     * that owns a boat should stop treating a lake as a wall. Not free, so that a two block puddle is still waded
     * rather than sailed.
     */
    public double boatEnterCost = 8D;

    /**
     * The cost of stepping off a boat back onto land, mirroring {@link #railsExitCost}.
     */
    public double boatExitCost = 4D;
    ...
    /**
     * Whether to use boat pathing across open water.
     */
    private boolean canUseBoat         = false;
    /**
     * Can swim
     */
    ...
    /**
     * Whether this entity may cross open water in a boat instead of swimming it.
     *
     * @return true if so.
     */
    public boolean canUseBoat()
    {
        return canUseBoat;
    }

    public void setCanUseBoat(final boolean canUseBoat)
    {
        this.canUseBoat = canUseBoat;
    }
    ...
    public PathingOptions withOnBoatCost(final double onBoatCost)
    {
        this.onBoatCost = onBoatCost;
        return this;
    }

    public PathingOptions withBoatEnterCost(final double boatEnterCost)
    {
        this.boatEnterCost = boatEnterCost;
        return this;
    }

    public PathingOptions withBoatExitCost(final double boatExitCost)
    {
        this.boatExitCost = boatExitCost;
        return this;
    }

    /**
     * Sets boating ability.
     *
     * @param canUseBoat whether boating is allowed.
     * @return this PathingOptions object.
     */
    public PathingOptions withCanUseBoat(final boolean canUseBoat)
    {
        setCanUseBoat(canUseBoat);
        return this;
    }
    ...
    public void importFrom(final PathingOptions pathingOptions)
    {
        ...
        onBoatCost = pathingOptions.onBoatCost;
        boatEnterCost = pathingOptions.boatEnterCost;
        boatExitCost = pathingOptions.boatExitCost;
        ...
        canUseBoat = pathingOptions.canUseBoat;
