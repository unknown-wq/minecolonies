...
public class EntityMercenary extends AbstractFastMinecoloniesEntity implements Npc, IColonyRelated
{
    ...
    public EntityMercenary(final EntityType<EntityMercenary> type, final Level world)
    {
        ...
        this.targetSelector.addGoal(5, new NearestAttackableTargetGoal<>(this, Monster.class, 10, true, false, (e, lvl) -> e instanceof Enemy && !(e instanceof Llama)));
    ...
    @Override
    protected void addAdditionalSaveData(final ValueOutput compound)
    {
    ...
    @Override
    protected void readAdditionalSaveData(final ValueInput compound)
    {
    ...
    @Override
    public boolean hurtServer(final ServerLevel serverLevel, final DamageSource source, final float damage)
    {
    ...
    public static void spawnMercenariesInColony(@NotNull final IColony colony)
    {
        ...
        {
            final EntityMercenary merc = (EntityMercenary) ModEntities.MERCENARY.create(world, EntitySpawnReason.MOB_SUMMONED);
