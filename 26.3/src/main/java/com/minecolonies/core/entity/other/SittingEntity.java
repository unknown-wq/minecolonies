...
public class SittingEntity extends Entity
{
     ...
     */
    @Override
    public boolean hurtServer(@NotNull final ServerLevel level, @NotNull final DamageSource source, final float amount)
    {
        return false;
    }

    @Override
    public boolean hurtClient(@NotNull final DamageSource source)
    {
        return false;
    }
    ...
    public static boolean sitDown(final BlockPos pos, final Mob entity, final int maxLifeTime)
    {
        ...
        final SittingEntity sittingEntity = (SittingEntity) ModEntities.SITTINGENTITY.create(entity.level(), EntitySpawnReason.MOB_SUMMONED);
