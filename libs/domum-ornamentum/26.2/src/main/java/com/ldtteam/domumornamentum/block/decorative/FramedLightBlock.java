...
public class FramedLightBlock extends AbstractBlock<FramedLightBlock> implements IMateriallyTexturedBlock, ICachedItemGroupBlock, EntityBlock
{
    ...
    {
        super(DOProps.of().mapColor(MapColor.WOOD).pushReaction(PushReaction.PUSH_ONLY).strength(BLOCK_HARDNESS, RESISTANCE).noOcclusion().lightLevel(state -> 15));
    ...
    //   (no vanilla or Fabric equivalent in 26.2). Waterlogged blocks of this type render the plain
