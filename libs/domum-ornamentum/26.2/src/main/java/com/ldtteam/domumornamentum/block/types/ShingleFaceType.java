...
public enum ShingleFaceType implements StringRepresentable
{
    ...
    /**
     * Identifier for the wood type's texture, plus a suffix used in texture locations, used in data generator for models
     *
    ...
    /**
     * Identifier for the wood type's texture, used in data generator for models
     *
     * @return textureLocation
     */
    ...
    /**
     * Identifier for the face's item, used in data generator for recipes
     *
