...
import com.ldtteam.domumornamentum.datagen.global.VanillaCompatibilityTagProvider;
...
/**
 * Single block tag provider that runs every domain sub provider.
 *
...
public class DomumOrnamentumBlockTagProvider extends FabricTagsProvider.BlockTagsProvider {
    ...
    private static final List<IBlockTagSubProvider> SUB_PROVIDERS = List.of(
            ...
            new VanillaCompatibilityTagProvider(),
