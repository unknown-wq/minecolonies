...
public class Cursor
{
    ...
    public static class TexturedCursorType extends CursorType
    {
        ...
        // 26.3: GLFW is gone, cursors are SDL now. CursorType#select lost its Window parameter
        // (/opt/mc-src-26.3/com/mojang/blaze3d/platform/Window.java:648-653 calls select() no-arg).
        @Override
        public void select()
        {
            ...
            SDLMouse.SDL_SetCursor(cursorTexture.getSdlCursorAddress());
        }
    }
}
