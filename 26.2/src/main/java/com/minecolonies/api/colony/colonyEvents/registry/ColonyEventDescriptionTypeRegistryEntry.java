...
public class ColonyEventDescriptionTypeRegistryEntry
{
     ...
     */
    public IColonyEventDescription deserializeEventDescriptionFromNBT(@NotNull final HolderLookup.Provider provider, @NotNull final CompoundTag compound)
    {
     ...
     * @return the deserialized event description.
     */
    public IColonyEventDescription deserializeEventDescriptionFromFriendlyByteBuf(@NotNull final RegistryFriendlyByteBuf buffer)
    {
