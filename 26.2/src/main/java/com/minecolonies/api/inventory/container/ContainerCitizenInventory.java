...
public class ContainerCitizenInventory extends AbstractContainerMenu
{
    ...
    public ContainerCitizenInventory(final int windowId, final Inventory inv, final int colonyId, final int citizenId)
    {
        ...
        List<GuardGear> guardGear = switch (workBuildingLevel)
        {
            ...
            case 1 -> GuardGearBuilder.buildGearForLevel(ARMOR_LEVEL_LEATHER, ARMOR_LEVEL_COPPER, LEATHER_BUILDING_LEVEL_RANGE, COPPER_BUILDING_LEVEL_RANGE);
        ...
        final IColony colony)
    {
        this.addSlot(new Slot(new SimpleContainer(inventory.getArmorInSlot(equipmentSlot)), 0, INVENTORY_BAR_SIZE + 215, 23 + index * PLAYER_INVENTORY_OFFSET_EACH)
        {
            ...
            {
                final Identifier icon = switch (equipmentSlot)
                {
                ...
                // 26.2: Slot#getNoItemIcon returns the sprite id directly, the atlas is implied.
                return icon;
            }
        });
    }
