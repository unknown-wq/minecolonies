...
public final class ModItems
{
    ...
    public static Item scepterClaim;
    public static Item scepterUnclaim;
    public static Item scepterBorder;
    public static Item scepterTerritory;
