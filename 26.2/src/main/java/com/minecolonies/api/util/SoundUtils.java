...
public final class SoundUtils
{
    ...
    /**
     * Replacement for NeoForge's {@code NoteBlockEvent.Note}, which has no Fabric or vanilla counterpart.
     * Same declaration order (note-block value 0..11 starting at F#), because {@link #getRandomPentatonic} uses
     * {@code ordinal()} as a semitone offset.
     */
    public enum Note
    {
