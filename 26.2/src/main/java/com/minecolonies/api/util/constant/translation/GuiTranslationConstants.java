...
public class GuiTranslationConstants
{
    ...
    // The button's own label, com.minecolonies.coremod.gui.field.mixseed, is referenced from windowfield.xml only,
    // the same way selectseed is; only the tooltip is built in code.
    @NonNls
    public static final String FIELD_GUI_MIX_SEED_TOOLTIP   = "com.minecolonies.coremod.gui.field.mixseed.tooltip";
