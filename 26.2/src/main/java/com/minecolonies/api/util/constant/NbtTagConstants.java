...
public final class NbtTagConstants
{
    ...
    /**
     * The 16x16 column mask of a partially claimed chunk, absent while the whole chunk is claimed.
     */
    public static final String TAG_PARTIAL_CLAIM       = "partialClaim";
    ...
    public static final String TAG_AGE_DAYS               = "ageDays";
    public static final String TAG_LIFE_JITTER            = "lifeJitter";
    ...
    /**
     * Parent citizen ids, written alongside the names since 26.2/Fabric. Absent in every older save, which is why the
     * names are still written and still read.
     */
    public static final String TAG_PARENT_A_ID = "parentAId";
    public static final String TAG_PARENT_B_ID = "parentBId";
    ...
    /**
     * This colony's answer to "force-load the whole claim?", written only when an operator has given one. Its absence
     * is meaningful: it is what makes the colony follow the {@code forceloadallclaims} server config instead.
     */
    public static final String TAG_FORCE_LOAD_ALL_CLAIMS = "forceloadallclaims";
    ...
    /**
     * Tag to store whether a colony shields its claimed chunks from blasts.
     */
    public static final String TAG_BLAST_PROTECTION = "blastProtection";

    /**
     * Tag to store whether a colony is a hostile territory rather than a colony anybody lives in.
     */
    public static final String TAG_HOSTILE_TERRITORY = "hostileTerritory";
