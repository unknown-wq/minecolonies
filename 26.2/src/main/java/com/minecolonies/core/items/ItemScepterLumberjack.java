...
public class ItemScepterLumberjack extends AbstractItemMinecolonies implements IBlockOverlayItem
{
    ...
    @Override
    public boolean canDestroyBlock(@NotNull final ItemStack heldStack, @NotNull final BlockState state, @NotNull final Level world, @NotNull final BlockPos pos, @NotNull final LivingEntity user)
    {
