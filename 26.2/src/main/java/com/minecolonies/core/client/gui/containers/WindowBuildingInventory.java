...
public class WindowBuildingInventory extends AbstractContainerScreen<ContainerBuildingInventory>
{
    ...
    {
        // PORT-26.2: imageHeight is final now, so it goes through the super constructor.
     ...
     */
    @Override
    public void extractBackground(@NotNull GuiGraphicsExtractor stack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        stack.blit(RenderPipelines.GUI_TEXTURED, TEXT, i, j + this.inventoryRows * SLOT_OFFSET + SLOT_OFFSET - 1, 0,
