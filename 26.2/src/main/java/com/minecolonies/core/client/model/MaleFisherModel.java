...
public class MaleFisherModel extends CitizenModel<AbstractEntityCitizen>
{
    ...
    public void setupAnim(@NotNull final CitizenRenderState state)
    {
        ...
        body.getChild("fishingPole").visible = state.renderMetadata.contains(RENDER_META_ROD);
        body.getChild("fish").visible = state.renderMetadata.contains(RENDER_META_FISH);
    }
}
