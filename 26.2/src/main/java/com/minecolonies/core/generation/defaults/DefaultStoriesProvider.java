...
public class DefaultStoriesProvider implements DataProvider
{
                                                      ...
                                                      @NotNull final CachedOutput cachedOutput)
    {
        ...
        json.add(new StoryBuilder(ColonyStoryListener.ABANDONED_COLONY_NAME)
                .addBiomeTag(ConventionalBiomeTags.IS_WET, ConventionalBiomeTags.IS_PLAINS)
                .addContents(
                        "Clearwater",
                        "Riverdale",
                        "Lakeside",
        ...
        json.add(new StoryBuilder(ColonyStoryListener.ABANDONED_COLONY_NAME)
                .addBiomeTag(ConventionalBiomeTags.IS_COLD)
                .addContents(
                        "Silvervale",
                        "Frostfield",
                        "Misty Hollow",
        ...
        json.add(new StoryBuilder(ColonyStoryListener.ABANDONED_COLONY_NAME)
                .addBiomeTag(ConventionalBiomeTags.IS_DESERT)
                .addContents(
                        "Goldenridge",
                        "Ashford"
                ).build());
    ...
    private static class StoryBuilder
    {
        ...
        {
            final String[] ids = Arrays.stream(biomes).map(b -> b.unwrapKey().orElseThrow().identifier().toString()).toArray(String[]::new);
