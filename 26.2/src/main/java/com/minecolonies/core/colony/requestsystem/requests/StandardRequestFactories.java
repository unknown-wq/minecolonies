...
public final class StandardRequestFactories
{
      ...
      final IObjectToNBTConverter<T> typeSerialization)
    {
        ...
        request.getDeliveries().forEach(itemStack -> deliveriesList.add(ItemStack.OPTIONAL_CODEC.encodeStart(provider.createSerializationContext(NbtOps.INSTANCE), itemStack).getOrThrow()));
