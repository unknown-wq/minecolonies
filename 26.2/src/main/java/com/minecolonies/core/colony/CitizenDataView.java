...
public class CitizenDataView implements ICitizenDataView
{
    ...
    /**
     * Ids of the parents, zero where this colony cannot name one. The server drops an id that no longer resolves to a
     * citizen of the recorded name, so anything here is safe to look up.
     */
    private Tuple<Integer, Integer> parentIds = new Tuple<>(0, 0);
    ...
    public void deserialize(@NotNull final RegistryFriendlyByteBuf buf)
    {
        ...
        parentIds = new Tuple<>(buf.readInt(), buf.readInt());
