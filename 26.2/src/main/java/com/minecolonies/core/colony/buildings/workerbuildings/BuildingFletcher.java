...
public class BuildingFletcher extends AbstractBuilding
{
    ...
    public static class CraftingModule extends AbstractCraftingBuildingModule.Crafting
    {
        ...
        public boolean isRecipeCompatible(@NotNull final IGenericRecipe recipe)
        {
            ...
            // PORT(26.2): ArmorItem/ArmorMaterials are gone; leather armour is now identified by the
            // equippable component's equipment asset.
            final Equippable equippable = recipe.getPrimaryOutput().get(DataComponents.EQUIPPABLE);
            return output instanceof ArrowItem
                     || (equippable != null
                           && recipe.getPrimaryOutput().has(DataComponents.DYED_COLOR)
                           && equippable.assetId().filter(EquipmentAssets.LEATHER::equals).isPresent());
        }
    }
