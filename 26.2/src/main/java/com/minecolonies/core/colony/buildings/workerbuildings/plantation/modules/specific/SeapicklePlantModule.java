...
public class SeapicklePlantModule extends BoneMealedPlantModule
{
    ...
    {
        // PORT(26.2): BoneMealItem#applyBonemeal is gone; it was growCrop || growWaterPlant.
        if (!BoneMealItem.growCrop(stackInSlot, worker.level(), workPosition.above()))
        {
            BoneMealItem.growWaterPlant(stackInSlot, worker.level(), workPosition.above(), null);
        }
