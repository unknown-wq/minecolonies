...
{
    /**
     * Replacement for NeoForge's {@code Tags.Blocks.STORAGE_BLOCKS}. NeoForge's common-tag tree does not exist
     * on Fabric; the equivalent convention tag is {@code c:storage_blocks}.
     */
    private static final net.minecraft.tags.TagKey<Block> COMMON_STORAGE_BLOCKS =
      net.minecraft.tags.TagKey.create(net.minecraft.core.registries.Registries.BLOCK,
        net.minecraft.resources.Identifier.fromNamespaceAndPath("c", "storage_blocks"));

    /**
     * Replacement for NeoForge's {@code Tags.Blocks.BOOKSHELVES}; the equivalent convention tag is
     * {@code c:bookshelves}.
     */
    private static final net.minecraft.tags.TagKey<Block> COMMON_BOOKSHELVES =
      net.minecraft.tags.TagKey.create(net.minecraft.core.registries.Registries.BLOCK,
        net.minecraft.resources.Identifier.fromNamespaceAndPath("c", "bookshelves"));
    ...
    public static double getScoreFor(final Block block)
    {
        ...
        else if (state.is(COMMON_STORAGE_BLOCKS))
        {
            score *= 9;
        }
        ...
        else if (state.is(COMMON_BOOKSHELVES))
        {
            score *= 3;
        }
