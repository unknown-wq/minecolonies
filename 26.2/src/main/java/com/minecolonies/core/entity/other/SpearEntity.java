...
public class SpearEntity extends ThrownTrident implements ICustomAttackSound
{
    ...
    protected void onHitEntity(EntityHitResult result)
    {
        ...
        if (targetEntity.hurtOrSimulate(damageSource, damageAmount))
        {
    ...
    @Override
    protected void readAdditionalSaveData(@NotNull ValueInput nbt)
    {
        super.readAdditionalSaveData(nbt);
        this.dealtDamage = nbt.getBooleanOr(NBT_DEALT_DAMAGE, false);
    }

    @Override
    protected void addAdditionalSaveData(@NotNull ValueOutput nbt)
    {
