...
public class NewBobberEntity extends Projectile
{
    ...
    public void tick() {
        ...
        // Before super.tick(), the way vanilla FishingHook does it: the interpolation step consumes the position the
        // server sent and moves the client's copy one increment towards it, and the simulation below then runs from
        // that position rather than fighting it.
