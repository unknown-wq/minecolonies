...
public class CitizenExperienceHandler implements ICitizenExperienceHandler
{
    ...
    public void dropExperience()
    {
        ...
        // 26.2: GameRules only hang off ServerLevel now, and RULE_DOMOBLOOT is MOB_DROPS.
        if (CompatibilityUtils.getWorldFromCitizen(citizen) instanceof final ServerLevel serverLevel
              && citizen.getRecentlyHit() > 0
              && citizen.checkCanDropLoot()
