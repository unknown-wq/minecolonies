...
public class PathPointExtended extends Node
{
    ...
    /**
     * Boat params. The water counterpart of the rails flags above: onBoat marks every node of a crossing that is
     * meant to be made in a boat, boatEntry the first of them and boatExit the first node back on land.
     */
    private boolean onBoat;
    private boolean boatEntry;
    private boolean boatExit;
    ...
    /**
     * Set if this node is travelled by boat.
     *
     * @param isOnBoat if on a boat.
     */
    public void setOnBoat(final boolean isOnBoat)
    {
        this.onBoat = isOnBoat;
    }

    /**
     * Set the boat entry.
     */
    public void setBoatEntry()
    {
        this.boatEntry = true;
    }
     ...
     * Set the boat exit.
     */
    public void setBoatExit()
    {
        this.boatExit = true;
    }

    /**
     * Whether this node is travelled by boat.
     *
     * @return true if so.
     */
    ...
    /**
     * Whether this is the boat entry.
     *
     * @return true if so.
     */
    public boolean isBoatEntry()
    {
        return boatEntry;
    }

    /**
     * Whether this is the boat exit.
     *
     * @return true if so.
     */
    public boolean isBoatExit()
    {
        return boatExit;
    }
