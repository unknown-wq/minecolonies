...
public class LayerBlueprintIterator extends AbstractBlueprintIteratorWrapper
{
    ...
    private static class StructureHandlerWrapper implements IStructureHandler {
        ...
        // 26.2: IStructureHandler#getInventory is declared with Structurize's own IItemHandler copy.
        @Override
        public @Nullable com.ldtteam.structurize.compat.itemhandler.IItemHandler getInventory()
        {
