...
public final class ModBlocksInitializer
{
    ...
    /**
     * Registers every block and then every block item.
     * <p>
     * Port note (contract C5): {@code RegisterEvent} is gone; the mod entry point calls this directly against
     * the vanilla registries, which is legal on Fabric for the whole duration of {@code onInitialize}.
     */
    public static void init()
    {
        init(BuiltInRegistries.BLOCK);
        registerBlockItem(BuiltInRegistries.ITEM);
    }
