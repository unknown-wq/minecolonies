...
**The history also remembered the wrong meal.** It is a queue new meals are added to the end of, and
the "what did you last eat" question read the front of it — the oldest meal still remembered rather
than the most recent one. So the repeat-meal check compared against the wrong food in both
directions: variety where a citizen had just eaten the same thing twice, monotony where they had
not.
